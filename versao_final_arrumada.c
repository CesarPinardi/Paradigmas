...
Matricula addMat() {
	...
	printf("\nPara parar o cadastro digite 'x' no nome e '0' no RA\n");
	do
	{
		printf("\nNome: ");
		scanf("%s", addM[qq].aluno.nome);
		strcpy(aux1, addM[qq].aluno.nome);
		printf("\nDigite o RA: ");
		scanf("%d", &addM[qq].aluno.ra);
		qq++;
		count++;

	} while ((strcmp(aux1, "x") != 0) && (addM[qq].aluno.ra != 0));
	...
	printf("\nTurma da disciplina em que os alunos serao matriculados (1 ou 2): ");
	scanf("%d", &auxT);
...
Matricula cancelaMat() {
	...
	{
		printf("\nNome: ");
		scanf("%s", canM[qq].aluno.nome);
		strcpy(aux1, canM[qq].aluno.nome);
		printf("\nDigite o RA: ");
		scanf("%d", &canM[qq].aluno.ra);
		qq++;
		count++;

	} while ((strcmp(aux1, "x") != 0) && (canM[qq].aluno.ra != 0));
	...
	printf("\nTurma da disciplina em que os alunos  serao removidos (1 ou 2): ");
	scanf("%d", &auxT);

	for (int vv = 0; vv < qq; vv++)
	{
		strcpy(canM[vv].aluno.nome, "00000");
...
Professor desvincular() {
	...
	} while ((strcmp(aux1, "x") != 0) && (desvinc[qq].reg) != 0);
		...
		case 7:
			...
			if (auxBusca != -1) {
				...
				while (v2 != 0)
				{
					...
					printf("\nDesvincular mais professores? 0 = Sair\nOp: ");
					scanf("%d", &v2);
					o++;
				}
			}
